...
@Component({
  selector: 'app-tarjetadecuentotres',
  templateUrl: './tarjetadecuentotres.component.html',
  styleUrls: ['./tarjetadecuentotres.component.css']
})
export class TarjetadecuentotresComponent implements OnInit {
  ...
  constructor(private afAuth: AngularFireAuth,
    ...
    ngOnInit() {
      const baseRef = collection(this.firestore, 'descuentos');
          ...
          data.subscribe(
            (res) => {
             this.titulo = res[2]['titulo'];
             this.descripcion = res[2]['descripcion'];
             console.log(res);

...
@Component({
  selector: 'app-tarjetadecuentodos',
  templateUrl: './tarjetadecuentodos.component.html',
  styleUrls: ['./tarjetadecuentodos.component.css']
})
export class TarjetadecuentodosComponent implements OnInit {
  ...
  constructor(private afAuth: AngularFireAuth,
    ...
    ngOnInit() {
      const baseRef = collection(this.firestore, 'descuentos');
          ...
          data.subscribe(
            (res) => {
             this.titulo = res[1]['titulo'];
             this.descripcion = res[1]['descripcion'];
             console.log(res);
